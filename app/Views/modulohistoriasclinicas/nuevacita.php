...
<html lang="es">
  <head>
    ...
    <link
      rel="stylesheet"
      href="<?= base_url('public/modulohistoriasclinicascss/nuevacita.css'); ?>" />
    <link
      rel="stylesheet"
          ...
          <div class="form-grid">
            <div class="info-item full-width">
              <textarea
                class="form-input"
                rows="4"
                placeholder="Descripción del interrogatorio"></textarea>
            </div>
          </div>
        </div>
        ...
        <div class="form-section">
          ...
          <div class="exam-checklist">
            <div class="checkbox-group">
              ...
              <label
                ><input type="checkbox" /> Biometría Hemática Completa</label
              >
              ...
              <label
                ><input type="checkbox" /> Hemoglobina Glucosilada
                (HbA1c)</label
              >
